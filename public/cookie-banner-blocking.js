...
function processUserConsentBasedOnPreference(
    ...
    <div id="customize-screen-privy-cmp-AE1VSVI8T5">
        <div class="customize-settings-screen-privy-cmp-AE1VSVI8T5">
            <div>
                ...
                <div class="content-privy-cmp-AE1VSVI8T5">
                    ...
                    ${Object.keys(categorizedCookies).map(category => {
                        ...
                        <div class="category-privy-cmp-AE1VSVI8T5">
                            ...
                            <div id="dropdown-${category}" class="dropdown-content-privy-cmp-AE1VSVI8T5">
 ...
 function showBanner() {
    ...
    if (!consentCookie){
        ...
        cookie.update = false;
        setCookieOnBrowser(cookie, cookieName)
        location.reload();
    }
